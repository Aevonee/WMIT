...
const RUNTIME_ACTION_WHITELIST = new Set([
  ...
  'getTodayOverview', 'globalSearch', 'getSalesOverview',
  'generateReminderDrafts', 'listReminderDrafts', 'discardReminderDraft',
  'generateSalesProposals', 'resolveAgentProposal',
...
function createPhase1Application(options) {
  ...
  updateRoomingListEntry: (input, actor) => call('updateRoomingListEntry', input, actor),
    ...
    getSalesOverview: (input, actor) => call('getSalesOverview', input, actor),
    ...
    generateSalesProposals: (input, actor) => call('generateSalesProposals', input, actor),
    resolveAgentProposal: (input, actor) => call('resolveAgentProposal', input, actor),
