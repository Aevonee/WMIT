...
module.exports = { CASE_PROJECTION_VERSION, CASE_STAGES, projectCase, projectCases, financeProjection, documentsProjection, serviceDocumentsProjection, getEntities };
